...
async function act() {
    try {
        ...
        const num = '0036625-20.2026.8.19.0001';
        console.log(`\n=== Solicitando Atualização: ${num} ===`);
        
        const res = await fetch(`https://api.escavador.com/api/v2/processos/numero_cnj/${num}/solicitar-atualizacao`, {
            method: 'POST',
            headers: {
