...
const DEFAULT_CAPABILITY_SEEDS: DefaultCapabilitySeed[] = [
  ...
  },
  {
    ...
    description: "Conduz onboarding operacional do escritorio por conversa: areas, tom, triagem, handoff, documentos, promessas proibidas, SLA, departamentos, permissoes, agenda, financeiro, playbooks, defaults por area juridica e grava respostas aprovadas no perfil central do MAYUS.",
    version: "1.0",
    schema_version: "1",
    input_schema: {
      type: "object",
      properties: {
        ...
        playbook_notes: { type: "string", description: "Roteiros ou playbooks de atendimento, vendas, agenda e cobranca." },
