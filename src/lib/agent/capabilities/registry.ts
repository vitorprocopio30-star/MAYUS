...
const DEFAULT_CAPABILITY_SEEDS: DefaultCapabilitySeed[] = [
  ...
  },
  {
    ...
    description: "Cria brief de inteligencia de gestao para o dono do escritorio, usando base curada Gestao Juridica BR e readiness financeiro/CRM; estrutura perguntas e cenarios sem decidir pelo dono.",
    version: "1.0",
    schema_version: "1",
    input_schema: {
      type: "object",
      properties: {
        request: { type: "string", description: "Pedido original do usuario sobre gestao, negocio, vendas, marketing ou financeiro." },
        focus_terms: {
          type: "array",
          items: { type: "string" },
          description: "Conceitos a explicar ou aplicar: CAC, LTV, margem, ticket medio, conversao, pipeline, forecast, ROI, CPL, capacidade, inadimplencia, produtividade ou tese lucrativa.",
        },
      },
    },
    output_schema: { type: "object" },
  ...
  },
  {
    ...
    description: "Conduz onboarding operacional do escritorio por conversa e cria a Metodologia Operacional: identidade, PUV, areas, triagem, documentos, fases, responsaveis, criterios, permissoes, agenda, financeiro, internet controlada e defaults por area juridica em modo supervisionado.",
    version: "1.0",
    schema_version: "1",
    input_schema: {
      type: "object",
      properties: {
        office_name: { type: "string", description: "Nome publico do escritorio." },
        practice_areas: { type: "array", items: { type: "string" }, description: "Areas juridicas atendidas." },
        ideal_client: { type: "string", description: "Cliente ideal do escritorio." },
        unique_value_proposition: { type: "string", description: "PUV ou diferencial do escritorio." },
        value_pillars: { type: "array", items: { type: "string" }, description: "Pilares de valor da metodologia e do atendimento." },
        anti_client_signals: { type: "array", items: { type: "string" }, description: "Perfis de clientes/casos que o escritorio prefere evitar." },
        communication_tone: { type: "string", description: "Tom de atendimento do MAYUS." },
        triage_rules: { type: "array", items: { type: "string" }, description: "Regras de triagem inicial." },
        human_handoff_rules: { type: "array", items: { type: "string" }, description: "Quando chamar humano." },
        required_documents_by_case: { type: "array", items: { type: "string" }, description: "Documentos por area ou tipo de caso." },
        forbidden_claims: { type: "array", items: { type: "string" }, description: "Promessas ou frases proibidas." },
        pricing_policy: { type: "string", description: "Regra para falar de preco/honorarios." },
        response_sla: { type: "string", description: "Prazo de resposta prometido." },
        departments: { type: "array", items: { type: "string" }, description: "Departamentos ou responsaveis." },
        permission_policy: { type: "string", description: "Quem aprova permissoes, contratos, cobrancas, envios externos e decisoes sensiveis." },
        calendar_policy: { type: "string", description: "Regras de agenda, consultas, retornos, audiencias e confirmacoes." },
        finance_policy: { type: "string", description: "Regras financeiras operacionais para cobranca, renegociacao, descontos, Asaas e inadimplencia." },
        playbook_notes: { type: "string", description: "Fases, criterios e rotinas da Metodologia Operacional. Playbooks viram artefatos secundarios." },
        confirmation: { type: "string", description: "Confirmacao textual do dono para gravar." },
      },
    },
    output_schema: { type: "object" },
    allowed_roles: [],
  ...
  },
  {
    ...
    description: "Analisa learning_events recentes, detecta padroes recorrentes e propoe memorias institucionais supervisionadas sem executar side effects externos.",
    version: "1.0",
    schema_version: "1",
    input_schema: {
      type: "object",
      properties: {
        lookback_days: { type: "number", description: "Janela de dias para revisar learning_events." },
      },
    },
    output_schema: { type: "object" },
    allowed_roles: EXECUTIVE_ROLES,
    allowed_channels: ["chat", "routine"],
    requires_human_confirmation: false,
    risk_level: "low",
    is_active: true,
    handler_type: "core_self_improvement_review",
  },
  {
  ...
  },
  {
    ...
    description: "Gera o Case Brain 2.0 do processo com cronologia estruturada, mapa de riscos, contradicoes, fatos documentados, inferencias e proximos atos provaveis, sem side effects externos.",
    version: "1.0",
    schema_version: "1",
    input_schema: {
      type: "object",
