...
export default function HallDaFamaPage() {
  return (
    <div className={`min-h-screen bg-white dark:bg-[#050505] text-gray-900 dark:text-white p-6 md:p-10 relative overflow-hidden ${montserrat.className}`}>
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-12 pb-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-[#CCA761]/30 pb-6">
          <div>
            <Link href="/dashboard/agenda-global" className="flex items-center gap-2 text-gray-500 hover:text-[#CCA761] transition-colors mb-4 w-fit px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/5 hover:border-[#CCA761]/30">
          ...
          <div className="bg-gray-100 dark:bg-[#111] border border-[#CCA761]/20 p-4 rounded-xl shadow-[0_5px_20px_rgba(204,167,97,0.1)] flex items-center gap-6">
             ...
             <div className="flex flex-col items-center">
               ...
               <span className="text-gray-900 dark:text-white font-black tracking-widest text-sm">2 Dias</span>
             </div>
          </div>
        </div>
        ...
        <div className="pt-8">
          <h2 className="text-xl font-bold tracking-widest uppercase mb-8 flex items-center gap-3 text-gray-900 dark:text-white border-b border-gray-200 dark:border-white/5 pb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* PÓDIO COMERCIAL */}
            <div className="bg-gray-100 dark:bg-[#111] border border-[#CCA761]/20 rounded-2xl p-6 shadow-lg flex flex-col h-full transform transition hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(204,167,97,0.1)]">
              ...
              <div className="flex-1 flex justify-center items-end gap-2 h-64 pb-0 pt-4">
                ...
                <div className="flex flex-col items-center flex-1 z-10 w-1/3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white dark:bg-[#0a0a0a] border-2 border-gray-400 flex items-center justify-center font-black text-gray-400 text-sm mb-2 shadow-[0_0_10px_rgba(156,163,175,0.2)]">
                    {MOCK_RANKINGS.Comercial[1]?.name ? MOCK_RANKINGS.Comercial[1].name.charAt(0) : '-'}
                  </div>
                  <span className="text-[10px] sm:text-xs font-bold text-gray-700 dark:text-gray-300 truncate w-full text-center px-1" title={MOCK_RANKINGS.Comercial[1]?.name}>{MOCK_RANKINGS.Comercial[1]?.name || '---'}</span>
                ...
                <div className="flex flex-col items-center flex-1 z-20 w-1/3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white dark:bg-[#0a0a0a] border-2 border-[#CCA761] flex items-center justify-center font-black text-[#CCA761] text-lg mb-2 shadow-[0_0_15px_rgba(204,167,97,0.4)] relative">
                  ...
                  <span className="text-xs sm:text-sm font-bold text-gray-900 dark:text-white truncate w-full text-center px-1" title={MOCK_RANKINGS.Comercial[0]?.name}>{MOCK_RANKINGS.Comercial[0]?.name || '---'}</span>
                ...
                {/* 3RD PLACE */}
                <div className="flex flex-col items-center flex-1 z-10 w-1/3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white dark:bg-[#0a0a0a] border-2 border-[#cd7f32] flex items-center justify-center font-black text-[#cd7f32] text-sm mb-2 shadow-[0_0_10px_rgba(205,127,50,0.2)]">
            ...
            {/* PÓDIO JURÍDICO */}
            <div className="bg-gray-100 dark:bg-[#111] border border-blue-500/20 rounded-2xl p-6 shadow-lg flex flex-col h-full transform transition hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(59,130,246,0.1)]">
              ...
              <div className="flex-1 flex justify-center items-end gap-2 h-64 pb-0 pt-4">
                ...
                <div className="flex flex-col items-center flex-1 z-10 w-1/3">
                  ...
                  <span className="text-[10px] sm:text-xs font-bold text-gray-700 dark:text-gray-300 truncate w-full text-center px-1" title={MOCK_RANKINGS.Jurídico[1]?.name}>{MOCK_RANKINGS.Jurídico[1]?.name || '---'}</span>
                ...
                {/* 1ST PLACE */}
                <div className="flex flex-col items-center flex-1 z-20 w-1/3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white dark:bg-[#0a0a0a] border-2 border-blue-500 flex items-center justify-center font-black text-blue-500 text-lg mb-2 shadow-[0_0_15px_rgba(59,130,246,0.4)] relative">
                  ...
                  <span className="text-xs sm:text-sm font-bold text-gray-900 dark:text-white truncate w-full text-center px-1" title={MOCK_RANKINGS.Jurídico[0]?.name}>{MOCK_RANKINGS.Jurídico[0]?.name || '---'}</span>
            ...
            {/* PÓDIO MARKETING */}
            <div className="bg-gray-100 dark:bg-[#111] border border-purple-500/20 rounded-2xl p-6 shadow-lg flex flex-col h-full transform transition hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(168,85,247,0.1)]">
              ...
              <div className="flex-1 flex justify-center items-end gap-2 h-64 pb-0 pt-4">
                ...
                <div className="flex flex-col items-center flex-1 z-10 w-1/3">
                  ...
                  <span className="text-[10px] sm:text-xs font-bold text-gray-700 dark:text-gray-300 truncate w-full text-center px-1" title={MOCK_RANKINGS.Marketing[1]?.name}>{MOCK_RANKINGS.Marketing[1]?.name || '---'}</span>
                ...
                {/* 1ST PLACE */}
                <div className="flex flex-col items-center flex-1 z-20 w-1/3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white dark:bg-[#0a0a0a] border-2 border-purple-500 flex items-center justify-center font-black text-purple-500 text-lg mb-2 shadow-[0_0_15px_rgba(168,85,247,0.4)] relative">
                  ...
                  <span className="text-xs sm:text-sm font-bold text-gray-900 dark:text-white truncate w-full text-center px-1" title={MOCK_RANKINGS.Marketing[0]?.name}>{MOCK_RANKINGS.Marketing[0]?.name || '---'}</span>
