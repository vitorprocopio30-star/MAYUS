...
export default function AgendaDiariaPage() {
  ...
  const fetchTasks = async () => {
    ...
    const assigneeScopedTasks = sourceSafeTasks.filter((task: any) => {
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 py-3 bg-gradient-to-r from-[#F0E6D6] dark:from-[#111111] to-transparent rounded-xl border-l-[3px] border-[#CCA761] mb-6 shadow-md gap-4">
