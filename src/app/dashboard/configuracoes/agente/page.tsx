...
function SkillCard({
  ...
  return (
    <div className={`relative bg-[#0d0d0d] border rounded-2xl p-5 transition-all duration-200 ${
      skill.is_active
    ...
    <div className={`p-6 max-w-4xl mx-auto ${montserrat.className}`}>
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        {[
          ...
          <div key={stat.label} className="bg-[#0d0d0d] border border-white/5 rounded-xl p-4 flex items-center gap-3">
            {stat.icon}
            <div>
