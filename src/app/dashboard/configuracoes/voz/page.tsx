  ...
  return (
    <div className={`p-6 max-w-4xl mx-auto space-y-8 animate-in fade-in py-10 ${montserrat.className}`}>
      ...
      <div className="grid gap-6">
        ...
        <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div 
              ...
              className={`cursor-pointer p-5 rounded-xl border transition-all duration-300 ${provider === "openai" ? "bg-[#10a37f]/10 border-[#10a37f] shadow-[0_0_20px_rgba(16,163,127,0.1)]" : "bg-[#141414] border-white/5 hover:border-white/10"}`}
            >
            ...
            <div 
              ...
              className={`cursor-pointer p-5 rounded-xl border transition-all duration-300 ${provider === "elevenlabs" ? "bg-white/10 border-white shadow-[0_0_20px_rgba(255,255,255,0.05)]" : "bg-[#141414] border-white/5 hover:border-white/10"}`}
            >
              <div className="flex items-center gap-3 mb-2">
        ...
        {provider === "openai" && (
          <div className="bg-[#141414] border border-[#10a37f]/30 rounded-2xl p-6 animate-in slide-in-from-top-2">
        ...
        {provider === "elevenlabs" && (
          <div className="bg-[#141414] border border-white/30 rounded-2xl p-6 animate-in slide-in-from-top-2 space-y-4">
