...
export default function ChatEquipePage() {
  ...
  return (
    <div className={`flex h-[calc(100vh-6rem)] w-full bg-[#020104] rounded-tl-3xl border-t border-l border-white/5 overflow-hidden ${montserrat.className}`}>
      ...
      <div className="w-[300px] flex-shrink-0 border-r border-white/5 flex flex-col bg-[#050505] z-10 relative">
         ...
         <div className="p-4 bg-gradient-to-br from-[#111] to-[#0a0a0a] border-t border-white/5 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center relative bg-black font-bold text-gray-400 text-xs uppercase">
         ...
         <div className="px-6 py-4 flex items-center justify-between bg-[#111]/80 backdrop-blur border-b border-white/5 z-10 sticky top-0">
            <div className="flex items-center gap-4">
               {isChannel ? (
                  ...
                  <div className="relative">
                     <div className="w-10 h-10 bg-[#050505] border border-white/10 rounded-full flex items-center justify-center font-bold text-sm uppercase">
            ...
            <div className="flex items-center gap-2">
               <button className="w-10 h-10 rounded-full border border-white/5 bg-[#050505] flex items-center justify-center text-gray-400 hover:text-white hover:border-[#CCA761]/50 hover:bg-[#CCA761]/5 transition-all"><Phone size={16} /></button>
               <button className="w-10 h-10 rounded-full border border-white/5 bg-[#050505] flex items-center justify-center text-gray-400 hover:text-white hover:border-[#CCA761]/50 hover:bg-[#CCA761]/5 transition-all"><Video size={16} /></button>
      ...
      {/* ----------------- PAINEL DIREITO (INFO) ----------------- */}
      <div className="w-[300px] flex-shrink-0 border-l border-white/5 bg-[#050505] flex flex-col z-10 hide-scrollbar overflow-y-auto hidden xl:flex">
