        ...
        <div className="max-w-4xl space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Nome do Processo</label>
              <input 
                type="text" 
                value={name}
          ...
          {false && <section className="space-y-6 pt-8 mt-8 border-t border-gray-200 dark:border-white/5">
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white tracking-wide">Automações do Processo</h2>
