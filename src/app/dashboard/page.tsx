...
import { Target, TrendingUp, TrendingDown, AlertCircle, ShieldCheck, ArrowDownRight, Users, Briefcase, Clock, Calendar, BarChart2, Star, CheckCircle, CheckCircle2, Smartphone, Mail, Instagram, Globe, Activity, ChevronDown, User as UserIcon } from "lucide-react";
      ...
      <GlassCard className="flex flex-col justify-between border-2 border-[#CCA761]/40 bg-gradient-to-br from-[#0d0d0d] via-[#111] to-[#CCA761]/15 px-8 py-7 shadow-[0_0_50px_rgba(204,167,97,0.1)] ring-1 ring-inset ring-[#CCA761]/20">
        <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-6">
          <div className="flex-1">
             ...
             <div className="flex flex-col mb-4">
                <h3 className="text-5xl 2xl:text-6xl font-black text-white tracking-tighter italic drop-shadow-[0_0_25px_rgba(204,167,97,0.5)]">
                  <span className="text-2xl 2xl:text-3xl text-[#CCA761] not-italic mr-2">R$</span><AnimatedNumber value={25400} />
                </h3>
             </div>
             <div className="flex flex-wrap gap-4 items-center">
                <div className="px-3 py-1 bg-black/40 rounded-full border border-[#CCA761]/30">
                  <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Alvo: R$ 40.000</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1 bg-[#4ade80]/10 rounded-full border border-[#4ade80]/20">
                  ...
                  <span className="text-[10px] text-[#4ade80] font-bold uppercase tracking-wider">Faltam R$ 14.600</span>
                </div>
             </div>
          </div>
          <div className="bg-[#CCA761]/10 border border-[#CCA761]/30 rounded-2xl p-4 flex flex-col items-center justify-center min-w-[140px]">
             ...
             <p className="text-[10px] text-[#CCA761] font-bold mt-1">+4 esta semana</p>
          </div>
        </div>
        <div className="h-px w-full bg-gradient-to-r from-transparent via-white/10 to-transparent my-6" />
        <div className="flex justify-between items-center px-4">
           <ElegantGoalGauge value={63} progress={63.5} label="Alcançado" color="#CCA761" />
           <ElegantGoalGauge value={18} progress={72} label="Contratos" color="#ffffff" valueSuffix="" />
           <ElegantGoalGauge value={7} progress={28} label="Faltam" color="#f87171" valueSuffix="" />
        </div>
      </GlassCard>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <GlassCard>
        ...
        <h3 className="text-3xl font-bold text-[#4ade80] tracking-wide mt-2">
          R$ <AnimatedNumber value={25400} />
        </h3>
        <div className="w-full bg-black h-1 mt-3 rounded-full overflow-hidden">
          <div className="bg-[#4ade80] h-full w-[65%]" />
        </div>
        <p className="text-[10px] text-gray-400 mt-2">65% de R$ 40.000,00</p>
      </GlassCard>
      <GlassCard>
        ...
        <h3 className="text-3xl font-bold text-[#b4a0f8] tracking-wide mt-2">
          R$ <AnimatedNumber value={4250} />
        </h3>
        <p className="text-[10px] text-[#4ade80] mt-2 flex items-center gap-1"><TrendingUp size={12}/> +12% vs. mês passado</p>
      </GlassCard>
      <GlassCard>
        <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold mb-1">Comissões Devidas (Closers)</p>
        <h3 className="text-3xl font-bold text-[#CCA761] tracking-wide mt-2">
          R$ <AnimatedNumber value={2100} />
        </h3>
        <p className="text-[10px] text-gray-400 mt-2">Modelo Progressivo ativo</p>
      </GlassCard>
      <GlassCard>
        <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold mb-1">Pipeline Aberto (Potencial)</p>
        <h3 className="text-3xl font-bold text-[#22d3ee] tracking-wide mt-2">
          R$ <AnimatedNumber value={125000} />
        </h3>
        <p className="text-[10px] text-gray-400 mt-2">42 Negociações Ativas</p>
      </GlassCard>
    </div>
       ...
       <GlassCard className="lg:col-span-1 border border-[#CCA761]/20">
         ...
         <div className="flex flex-col items-center gap-1.5 w-full">
           ...
           <div className="w-[50%] bg-[#4ade80]/20 border border-[#4ade80]/50 text-center py-3 rounded-b-lg relative">
             <span className="text-sm font-bold text-white relative z-10"><AnimatedNumber value={18}/> Fechamentos</span>
         ...
         <div className="mt-8 pt-4 border-t border-white/5 flex flex-col justify-between text-xs gap-2">
           <div className="flex justify-between items-center"><span className="text-gray-500">Ticket Médio:</span><span className="text-white font-bold">R$ 4.250</span></div>
  ...
  <div className="space-y-6 animate-fade-in-up">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <GlassCard>
        ...
        <h3 className="text-3xl font-bold text-[#4ade80] tracking-wide mt-2">
          R$ <AnimatedNumber value={15800} />
        </h3>
        <p className="text-[10px] text-gray-400 mt-2">Honorários + Êxito</p>
      </GlassCard>
      <GlassCard>
        <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold mb-1">Receita Recorrente (MRR)</p>
        <h3 className="text-3xl font-bold text-[#CCA761] tracking-wide mt-2">
          R$ <AnimatedNumber value={8500} />
        </h3>
        <p className="text-[10px] text-gray-400 mt-2">Parcelas Asaas ativas</p>
      </GlassCard>
      <GlassCard>
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex justify-between items-center text-sm font-medium mb-2">
              ...
              <span className="text-[#4ade80]">R$ 15.800,00</span>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-[#f87171]">- R$ 1.250,00</span>
              </div>
              <div className="flex justify-between items-center">
          ...
          <div className="pt-4 border-t border-white/5 flex justify-between items-center font-bold">
            ...
            <span className="text-[#4ade80]">R$ 1.050,00</span>
          </div>
        </div>
      </GlassCard>
...
const AgendaView = () => {
  ...
  const EVENTS = [
    { time: "09:00", title: "Review de Leads Marketing", category: "Comercial", person: "Equipe SDR", type: "Reunião", color: "#CCA761", done: true },
    { time: "10:30", title: "Fechamento: Empresa Alpha S.A.", category: "Vendas", person: "Ana S. (Closer)", type: "Vídeo Chamada", color: "#4ade80", active: true },
    { time: "14:00", title: "Audiência Virtual (TJSP)", category: "Judicial", person: "Dr. Marcos T.", type: "Audiência", color: "#22d3ee" },
    { time: "16:30", title: "Alinhamento DRE Semanal", category: "Financeiro", person: "Sócios", type: "Interno", color: "#b4a0f8" },
    { time: "18:00", title: "Follow-up leads frios", category: "CRM", person: "Equipe", type: "Automático", color: "#9ca3af" },
  ];
  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      ...
      {/* Grid: Timeline Global e Painel Lateral */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        
        {/* Timeline Centralizada */}
        <div className="lg:col-span-2 space-y-6">
           <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-[#111111] to-transparent rounded-xl border-l-[3px] border-[#CCA761] mb-6 shadow-md">
              ...
              <div className="flex gap-2">
                 <button className="text-[10px] text-gray-400 font-bold uppercase tracking-widest bg-white/5 px-3 py-1 rounded-lg border border-white/5">Hoje</button>
                 <button className="text-[10px] text-gray-400 font-bold uppercase tracking-widest hover:text-white">Filtros</button>
              </div>
           </div>
              ...
              {EVENTS.map((ev, i) => (
                <div key={i} className="group relative flex items-center gap-6">
                  ...
                  <div className="w-16 text-right shrink-0">
                    <span className={`text-base font-black italic tracking-tighter ${ev.active ? 'text-[#CCA761]' : 'text-gray-500'}`}>{ev.time}</span>
                  </div>

                  {/* Card do Evento Luxuoso */}
                  <div 
                     className={`flex-1 flex items-center justify-between p-5 rounded-2xl border transition-all duration-500 cursor-pointer overflow-hidden relative shadow-lg ${
                        ev.active 
                  ...
                  >
                     {/* Borda de Destaque Colorida (Background Gradiente Suave) */}
                     ...
                     <div className="flex items-center gap-5 relative z-10">
                        ...
                        <div>
                           ...
                           <h4 className={`text-base font-bold tracking-wide transition-colors ${
                              ev.done ? 'text-gray-600 line-through decoration-gray-700' : 'text-gray-100 group-hover:text-white'
                           }`}>{ev.title}</h4>
                        </div>
                     </div>
                  ...
                  {ev.active && <div className="absolute -left-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-[#CCA761] rounded-full animate-ping opacity-20" />}
                </div>
              ))}
           </div>
        </div>
        ...
        <div className="space-y-6">
           ...
           <div className="p-6 rounded-2xl border border-[#CCA761]/30 bg-gradient-to-br from-[#CCA761]/20 to-transparent">
              ...
              <h5 className="text-sm font-bold text-white mb-2 tracking-wide">Insight da Inteligência</h5>
...
export default function DashboardHomePage() {
  ...
  if (loading) {
    return (
      <div className={`h-full flex items-center justify-center ${montserrat.className}`}>
                ...
                <div className="absolute top-14 right-0 w-[240px] bg-[#0a0a0a] border border-[#CCA761]/30 rounded-xl shadow-2xl py-2 flex flex-col overflow-hidden z-[100]">
                  {TABS.map((tab) => (
                    <button
                      ...
                      className={`text-right px-6 py-3.5 text-[11px] font-bold uppercase tracking-widest transition-all hover:bg-white/5 border-l-2 ${
                        activeView === tab.id ? "text-[#0a0a0a] bg-[#CCA761] hover:bg-[#b58e46] border-transparent" : "text-gray-400 hover:text-[#CCA761] border-transparent"
                      }`}
                    >
                      {tab.label}
                    </button>
