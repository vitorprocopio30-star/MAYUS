...
import { buildAgendaPayloadFromManualTask, buildAgendaPayloadFromMission, filterExistingProcessPrazoTasks, sortAgendaTasks, toAgendaEvent } from "@/lib/agenda/userTasks";
...
export default function AgendaAdminPage() {
  ...
  const fetchAllTasks = async () => {
    ...
    const sourceSafeTasks = await filterExistingProcessPrazoTasks(supabase, allTasks || []);
    const normalized = sortAgendaTasks(sourceSafeTasks).map(toAgendaEvent);
    setTasks(normalized);
    setIsLoading(false);
  };
