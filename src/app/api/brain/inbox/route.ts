...
import { buildBrainInboxOperationalSummary } from "@/lib/brain/operational-summary";
...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      operational_summary: buildBrainInboxOperationalSummary((recentEvents || []) as LearningEventRow[]),
    });
  } catch (error) {
