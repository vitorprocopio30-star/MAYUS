          ...
          <div className="lg:col-span-3 space-y-6">
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className="w-full bg-black/50 border border-white/10 text-white rounded-lg px-4 py-3 text-lg font-semibold focus:outline-none focus:border-[#CCA761]/50 placeholder-white/30 transition-colors"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    <input 
                      ...
                      className="flex-1 bg-black/50 border border-white/10 text-white rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#CCA761]/50 placeholder-white/30 transition-colors"
                    ...
                    {taskPhone && (
                      <a 
                        ...
                        className="bg-[#25D366] hover:bg-[#20bd5a] text-black p-3 rounded-lg transition-colors flex items-center justify-center shadow-[0_0_15px_rgba(37,211,102,0.3)] shrink-0"
               ...
               <div className="space-y-6 lg:border-l lg:border-white/5 lg:pl-6">
                ...
                <div className="space-y-1.5 flex flex-col pt-2 border-t border-white/5">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2 p-3 bg-black/50 border border-white/10 rounded-lg min-h-[50px]">
