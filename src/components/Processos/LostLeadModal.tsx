...
export default function LostLeadModal({ isOpen, onClose, onSuccess }: LostLeadModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#0a0a0a] border border-red-500/30 rounded-2xl shadow-[0_0_60px_rgba(239,68,68,0.15)] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
           <div className="space-y-1.5">
             ...
             <textarea 
               ...
               className="w-full bg-[#1a1a1a] border border-[#2a2a2a] text-white rounded-lg px-4 py-3 focus:outline-none focus:border-red-500/50 transition-colors placeholder-gray-700 min-h-[120px] resize-none"
           ...
           <div className="pt-4 flex gap-3">
             ...
             <button type="submit" disabled={isLoading || !motivo.trim()} className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg font-bold text-white bg-red-600 hover:bg-red-700 transition-all disabled:opacity-50">
