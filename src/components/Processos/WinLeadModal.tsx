...
export default function WinLeadModal({ isOpen, onClose, onSuccess, defaultName = "" }: WinLeadModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#0a0a0a]/95 backdrop-blur-3xl border border-[#CCA761]/30 rounded-2xl shadow-[0_0_60px_rgba(204,167,97,0.15)] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
           ...
           <div className="space-y-4">
             ...
             <div className="space-y-1.5">
               ...
               <input 
                 ...
                 className="w-full bg-black/50 border border-white/10 text-white rounded-lg px-4 py-3 focus:outline-none focus:border-[#CCA761]/50 placeholder-white/30 transition-colors"
             ...
             <div className="space-y-1.5">
               ...
               <input 
                 ...
                 className="w-full bg-black/50 border border-white/10 text-white rounded-lg px-4 py-3 focus:outline-none focus:border-[#CCA761]/50 transition-colors"
             ...
             <div className="space-y-1.5">
               ...
               <input 
                 ...
                 className="w-full bg-black/50 border border-white/10 text-[#CCA761] font-bold text-lg rounded-lg px-4 py-3 focus:outline-none focus:border-[#CCA761]/50 transition-colors"
           ...
           <div className="pt-4 flex gap-3">
             <button type="button" onClick={onClose} disabled={isLoading} className="flex-1 px-4 py-3 rounded-lg font-semibold text-gray-400 hover:text-white hover:bg-white/5 transition-colors">
               Cancelar
             </button>
