...
Evidencia 2026-05-14: `src/lib/marketing/ai-native-narrative.ts` gera estrategia, pilares, banco de 6 colunas, modelagem anti-copia, lote por dor e Semana 1 de Instagram; `/dashboard/marketing` exibe a narrativa e `/dashboard/marketing/calendario` cria as 7 pautas editaveis sem publicar ou enviar DM automaticamente.
