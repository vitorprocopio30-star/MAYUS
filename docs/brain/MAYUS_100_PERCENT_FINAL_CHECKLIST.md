...
- [~] Peças Verificáveis: geracao, aprovacao/publicacao e export oficial agora exigem Evidence Pack atual pronto, snapshot verificavel e fonte factual auditavel; falta smoke real com acervo juridico volumoso e fluxo de atualizar snapshot sem alterar texto.
