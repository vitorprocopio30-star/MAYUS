...
| Juridico/Lex | 84% | Base juridica e documental esta forte; beta de revisao humana de movimentacoes, Kanban/prazo seguro e badges de origem ja foram mergeados; faltam classificador juridico com polo/obrigacao/motivo de confianca, cronologia persistente, documentos profundos e pecas com fontes verificaveis. |
...
- [ ] Evoluir classificador de movimentacoes com `polo_representado`, `obrigacao_de_quem`, `confidence_reason` e `review_required` explicito antes de aumentar automacao.
