...
- [x] Beta Juridico + WhatsApp Agentic fechado localmente em 2026-05-23: pedidos de peca viram missao processual antes da Draft Factory, approvals de minuta carregam `piece_context`/checklist/guardrails OpenClaw, WhatsApp classifica conversa e persiste Paperclip/OpenClaw/Hermes no metadata. Validado com 159 testes focados, typecheck, diff-check e HTTP smoke local; smoke autenticado real segue pendente por ambiente.
- [~] Prova beta real tentada em 2026-05-23: foco Lex/WhatsApp continuou verde em 159 testes e typecheck, mas o dev server local nao serviu HTTP nas rotas `/dashboard/mayus`, `/dashboard/aprovacoes`, `/dashboard/conversas/whatsapp` e `/dashboard/configuracoes/agente`; E2E Lex contra `127.0.0.1:3001` estourou timeout. Evolution real segue pendente por falta de configuracao visivel do canal nesta sessao.
...
- [x] Maquina de narrativa AI-native do Instagram MAYUS entregue em 2026-05-14: criado motor puro `src/lib/marketing/ai-native-narrative.ts` com estrategia, pilares, banco de 6 colunas, modelagem anti-copia, lote por dor e Semana 1 de Instagram; `/dashboard/marketing` mostra o painel de narrativa e `/dashboard/marketing/calendario` gera as 7 pautas iniciais como calendario editavel, sem publicacao/DM externa automatica.
...
- [x] Implantar maquina de narrativa AI-native do Instagram com banco de 6 colunas, modelagem anti-copia e gerador da Semana 1 no calendario.
